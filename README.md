...
действуют лимиты 2 запроса на пользователя за 10 минут, 5 запросов суммарно за
10 минут и 20 запросов в сутки. Повторный VIN берётся из SQLite-кэша без нового
обращения к Gemini.
